  ...
  var defaults = {
        ...
        return this.each(function () {
          ...
          if (settings.options.sniffHtml) {
            ...
            if (
              ...
              message =
                "Veuillez entrer une adresse mail valide<!-- data-validator-validemail-message to override -->";
    ...
    builtInValidators: {
      ...
      validemail: {
        ...
        message:
          "Ceci n'est pas une adresse email valide!<!-- data-validator-validemail-message to override -->",
      },
      passwordagain: {
        name: "Passwordagain",
        type: "match",
      ...
      required: {
        ...
        type: "required",
        message:
          "Ce champs est obligatoire<!-- data-validator-required-message to override -->",
      },
      checkone: {
        name: "Checkone",
        type: "minchecked",
